...
extends Menu {
    ...
    public void drawScreen(int n, int n2, float f) {
        ...
        this.b(ShaderQueueType.REGULAR).c(() -> {
            ...
            FontManager.MAIN.a(18, FontWeight.REGULAR).drawCenteredString(":D", scaledResolution.getScaledWidth() - 5, scaledResolution.getScaledHeight() - 20, ColorUtil.withAlpha(aBS, 100).getRGB());
